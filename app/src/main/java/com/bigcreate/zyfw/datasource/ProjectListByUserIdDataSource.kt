...
class ProjectListByUserIdDataSource(private val simplePageRequest: SimplePageRequest, private val networkState: MutableLiveData<NetworkState>) : PageKeyedDataSource<Int, SearchModel>() {
    ...
    override fun loadAfter(params: PageKeyedDataSource.LoadParams<Int>, callback: PageKeyedDataSource.LoadCallback<Int, SearchModel>) {
        ...
        RemoteService.getOtherUserReleasedList(simplePageRequest).enqueue(object : Callback<JsonObject> {
